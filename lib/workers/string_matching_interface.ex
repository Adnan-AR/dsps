defmodule StringMatching.Interface do
  @moduledoc """
  ...
  @spec update(String.t, list(String.t)) :: :ok | {:ok, String.t()}
  def update(name, patterns),
    do: @sm_server.update(name, patterns)
  @spec search(String.t, String.t ) :: MapSet.t()
                                     | {:error, String.t()}
  def search(name, string),
    do: @sm_server.search(name, string)
end
